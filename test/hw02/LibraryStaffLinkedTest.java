 ...
 * @author ercan
 */
public class LibraryStaffLinkedTest {
    
    public LibraryStaffLinkedTest() {
    }
    ...
    public void testBarrowBook() throws Exception {
        ...
        Books obj = new Books("name", "author", "type", 0);
        LibraryStaffLinked instance = new LibraryStaffLinked(0, "", "", "", "", "");
        instance.addBook(obj);
    ...
    public void testReturnBook_NullPointerException() throws Exception {
        ...
        Books obj = null;
        LibraryStaffLinked instance = null;
    ...
    public void testRegister() {
        ...
        LibraryUsersLinked lib_user = new LibraryUsersLinked(0, "", "", "", "", "");
        LibraryStaffLinked instance = new LibraryStaffLinked(0, "", "", "", "", "");
        boolean expResult = true;
