 ...
 * @author ercan
 */
public class AdminLinked extends Register{
...
/**
    ...
    /**
     * Library staff linkedlist.
     */
    private List<LibraryStaffLinked> library_staffs = new LinkedList<>();
    /**
     * Default constructor
     */
    public AdminLinked() {
     ...
     */
    public AdminLinked(int userID,String username, String password, String name, String surname, String email,String adminCode) {
        super(userID, username, password, name, surname, email);
        this.adminCode = adminCode;
    }
   /**
    * Getter administer code
    * @return administer code
    */
     ...
     */
    public boolean add(LibraryStaffLinked staff)throws NullPointerException{
        if(staff == null)
     ...
     */
    public boolean remove(LibraryStaffLinked staff)throws NullPointerException,Error{
       if(staff == null)
