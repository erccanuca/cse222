...
public abstract class LibrarySystemAbstract extends Register implements ProcessLibrarySystem{
    ...
    protected List<LibraryUsers> library_users = new ArrayList<>();
    protected List<Books> library_books = new ArrayList<>();
     ...
     */
    public List<LibraryUsers> getLibrary_users() {
     ...
     */
    public void setLibrary_users(List<LibraryUsers> library_users) {
