 ...
 * @author ercan
 */
public class LibraryStaffLinked extends LibrarySystemAbstractLinked{
  /**
     * Number of books are library staff own books.
     */
    private List<Books> numberofbooks = new ArrayList<>();
     ...
     */
    public LibraryStaffLinked(int userID, String username, String password, String name, String surname, String email) {
     ...
     */
    public boolean register(LibraryUsersLinked lib_user)throws NullPointerException{
        if(lib_user==null)
     ...
     */
    public boolean deregister(LibraryUsersLinked lib_user)throws NullPointerException,Error{
        if(lib_user == null)
